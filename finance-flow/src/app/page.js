  ...
  return (
    <div className="bg-cover h-screen flex items-center justify-center" style={{backgroundImage: `url('/images/login-bg.jpg')`}}>
      <div className="bg-white h-[90%] w-4/5 flex flex-col items-center rounded-lg">
        ...
        <form className="mt-8 flex flex-col items-left w-3/4" onSubmit={handleSubmit}>
          <h2>Username/email</h2>
          <input className="px-3 mt-3 w-full h-12 rounded-md border-2 border-gray-300 focus:outline-none focus:border-blue-500" type="text" placeholder="Email" />

          <h2 className="mt-5">Password</h2>
          <input className="px-3 mt-3 w-full h-12 rounded-md border-2 border-gray-300 focus:outline-none focus:border-blue-500" type="password" placeholder="Password" />

          <a className="text-blue-500 mt-3 text-sm self-end" href="#">Register</a>
